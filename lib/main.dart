...
class _HomePageState extends State<HomePage> {
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  'الأيام المجانية: $daysLeftInTrial يوم',
          ...
          Expanded(
            child: Padding(
              ...
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  _buildButton('🎓', Colors.orange, 'تعلم حرفة'),
                  const SizedBox(height: 20),
                  _buildButton('🛒', Colors.blue, 'سوق الحومة'),
                  const SizedBox(height: 20),
                  _buildButton('💰', Colors.green, 'فلوسي'),
                ],
              ),
            ),
          ),
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    const SizedBox(width: 10),
                    const Text('الدعم عبر واتساب', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
                  ],
                ),
              ),
            ),
  ...
  Widget _buildButton(String icon, Color color, String label) {
